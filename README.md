...
$$\displaystyle\frac{d \psi}{dx} \Big|_{\displaystyle x_i}$$

$$ = \frac{1}{2}\left( \frac{\psi(x_{i+1}) - \psi(x_i)}{\Delta x} + \frac{\psi(x_i) - \psi(x_{i-1})}{\Delta x} \right)$$
...
$$\displaystyle\frac{d^2 \psi}{dx^2} \Big|_{\displaystyle x_i}$$

$$ = \frac{1}{\Delta x}\left( \frac{\psi(x_{i+1}) - \psi(x_i)}{\Delta x} - \frac{\psi(x_i) - \psi(x_{i-1})}{\Delta x} \right)$$
